<div class="modal fade" id="kt_modal_add_kerja" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="kt_modal_add_kerja_form" method="POST" action="">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="posisi_kerja" class="form-label required">Posisi Kerja</label>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="tempat_kerja" class="form-label required">Tempat Kerja</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="alamat_kerja" class="form-label required">Alamat Tempat Kerja</label>
